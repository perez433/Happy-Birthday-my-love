...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey there Glory, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      "May this days and years be filled with lots of laughter, love, and unforgettable memories. I hope you get to spend your special day surrounded by the people you care about, doing all the things that make you happy.",
      ...
      "You're a true gem, Babe, and I feel lucky to know you. Happy birthday and cheers to a fantastic year ahead!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      "Happy Birthday Babe 😘! On this special day, I hope that all of your dreams come true and that you are surrounded by love and happiness. You are a wonderful person who deserves nothing but the best, and I feel honored to be able to celebrate this special day with you.",
      ...
      "Once again, happy birthday, Uri! Cheers to another year of laughter, love, and wonderful memories.",
      "Warm regards,",
